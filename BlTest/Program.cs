                    ...
                    case volunteerMenu.Update:
                        {
                            ...
                            {
                                // Validate if the address is correct (calculating latitude and longitude)
                                if (!IsValidAddress(updatedVolunteer.FullAddress, out double latitude, out double longitude))
                                {
                                    Console.WriteLine("Invalid address. Could not get valid coordinates.");
                                    return;
                                }
                            ...
                            // Validate values (check format like email, phone number, and Taz validity)
                            if (!IsValidEmail(updatedVolunteer.Email))
                            {
                                throw new ArgumentException("Invalid email format.");
                            }

                            if (!IsValidPhoneNumber(updatedVolunteer.PhoneNumber))
                            {
