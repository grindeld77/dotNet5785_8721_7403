        ...
        CallType[] callTypes =
{
    ...
    "Injury during a rescue mission."
        ...
        for (int i = 0; i < 30; i++)
        {
            ...
            s_dalCall!.Create(new Call
            {
                ...
                OpenedAt = s_dalConfig.Clock.AddDays(-s_rand.Next(1, 450)),
                MaxCompletionTime = s_dalConfig.Clock.AddDays(s_rand.Next(1, 180))
            });
        }
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            s_dalCall!.Create(new Call
            {
                ...
                Longitude = callLongitudes[i],
                OpenedAt = s_dalConfig.Clock.AddDays(-s_rand.Next(1, 450)),
                MaxCompletionTime = OpenedAt.AddDays(s_rand.Next(s_dalConfig.Clock - OpenedAt)) //*
            });
        }   
    }
    private static void createAssignments() //*****
    {
        for (int i = 0; i < 50; i++)
        {
            ...
            {
                CallId = i,
                VolunteerId =  ID[s_rand.Next(0, 14)],
